...
class archivo {
    ...
    public function __construct(string $fileName,string $contentStr, array $content){
        $this->fileName=$fileName;
        $this->content = [];
        $this->contentStr = str_getcsv($this->content); //Convierte un string con formato csv en un array
    }
